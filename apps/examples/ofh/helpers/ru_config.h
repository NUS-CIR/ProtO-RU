 ...
 */
 ...
 struct ru_sdr_unit_logger_config {
   srslog::basic_levels radio_level = srslog::basic_levels::warning;
 ...
 struct ru_sdr_unit_cpu_affinities_cell_config {
  ...
  //  os_sched_affinity_config ru_cpu_cfg = {sched_affinity_mask_types::ru, [](){
  ...
  //  }(), sched_affinity_mask_policy::mask};
   ...
   /// ofh rx CPU affinity mask.
   os_sched_affinity_config rx_cpu_cfg = {sched_affinity_mask_types::ofh_rx, {}, sched_affinity_mask_policy::mask};
   /// ru_timing CPU affinity mask.
   os_sched_affinity_config timing_cpu_cfg = {sched_affinity_mask_types::ru_timing, {}, sched_affinity_mask_policy::mask}; 
 };
 ...
 struct ru_sdr_unit_config {
   ...
   /// RF driver arguments for zmq.
   //std::string device_arguments = "tx_port=tcp://*:5000,rx_port=tcp://localhost:6000,base_srate=61.44e6";
   /// RF driver arguments for uhd.
